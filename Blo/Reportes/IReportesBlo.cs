...
namespace Blo.Reportes
{
    public interface IReportesBlo
    {
        ...
        /// <summary>
        /// Metodo en el que se genera reporte detalle de una persona listada en la lista ONU
        /// </summary>
        ...
        /// <summary>
        /// Metodo en el que se genera reporte detalle de una persona listadas en una o mas listas personalizadas
        /// </summary>
        /// <param name="idPersona">ID de la Persona en la lista</param>
        /// <returns>Lista dinámica de información requerida para el reporte</returns>
        ...
        /// <returns>Lista de transacciones por cliente</returns>
        ...
        /// <summary>
        /// Metodo que genera el reporte de transacciones en un rango de fechas.
        /// </summary>
        /// <param name="fechaInicial"></param>
        /// <param name="fechaFinal"></param>
        /// <returns>Lista de transacciones por rango de fechas</returns>
