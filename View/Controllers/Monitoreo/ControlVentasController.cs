...
namespace View.Controllers.Monitoreo
{
    [NoCache]
    [Autorizacion]
    public class ControlVentasController : BaseControlPagosController
    {
        /// <summary>
        ...
        /// </summary>
        public ControlVentasController
            ...
            Nullable<decimal> montoMinimo, Nullable<decimal> montoMaximo, string estado)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(rangoFechas)  && !string.IsNullOrEmpty(prestamo) && !string.IsNullOrEmpty(rangoMonto))
                    condicionSQL = "T.CLASE_PRODUCTO = 'VC' AND " + rangoFechas + " AND " + prestamo + " AND " + rangoMonto + estados;
                else if (!string.IsNullOrEmpty(rangoFechas) && !string.IsNullOrEmpty(rangoMonto))
                    condicionSQL = "T.CLASE_PRODUCTO = 'VC' AND " + rangoFechas + " AND " + rangoMonto + estados;
                else if (!string.IsNullOrEmpty(rangoFechas)  && !string.IsNullOrEmpty(prestamo))
                    condicionSQL = "T.CLASE_PRODUCTO = 'VC' AND " + rangoFechas + " AND " + prestamo + estados;
                else if (!string.IsNullOrEmpty(rangoFechas))
                    condicionSQL = "T.CLASE_PRODUCTO = 'VC' AND " + rangoFechas + estados;
