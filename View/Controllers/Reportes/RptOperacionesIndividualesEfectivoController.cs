...
namespace View.Controllers.Reportes
{
    [NoCache]
    [Autorizacion]
    public class RptOperacionesIndividualesEfectivoController : BaseController
    {
        /// <summary>
        ...
        /// </summary>
        public RptOperacionesIndividualesEfectivoController(IReportesBlo reportesBlo)
        {
        ...
        public ActionResult Reporte(string fechaInicial, string fechaFinal, string formato)
        {
            ...
            try
            {
                string nombreReporte = "RptOperacionesIndividualesEfectivoIgualesSuperioresA10000";
                string nombreTabla = "VIEW_TRANSACCIONES";

                var datosReporte = _reportesBlo.ReporteOperacionesIndividualesEfectivoIgualesSuperioresA10000(fechaIni, fechaFin);
